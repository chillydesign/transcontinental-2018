...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<div class="page_image homepage_image">
			<div class="container">
				<h1><?php the_title(); ?></h1>
				<a class="top_button button" href="<?php echo $home_url; ?>/demande-de-renseignements">
					<h6>Contactez-nous pour organiser votre voyage</h6>
				</a>
			</div>
		...
		<div class="container">
			<div class="welcome-section">
				<?php the_content(); ?>
				<a href="<?php echo $home_url; ?>/demande-de-renseignements" class="button" style="margin-top:20px; display:block;">
					<h6>Contactez-nous pour organiser votre voyage</h6>
				</a>
			</div>
		</div>
		...
		<div class="offers">
			<div class="container">
				...
				<a href="<?php echo $home_url; ?>/offre" class="button" style="display:block; text-align:center;">
					<h6>Découvrir toutes nos offres</h6>
				</a>
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="offre_content">
							...
							<a class="readmore" href="<?php echo $home_url; ?>/reservations-2424-h">
					...
					<div class="col-sm-6">
						...
						<div class="offre_content">
							...
							<a class="readmore" href="<?php echo $home_url; ?>/pour-offrir">
								<h6>Offrir un voyage</h6>
							</a>
						</div>
		...
		<div class="locations">
			...
			<?php if (is_zenith()) : ?>
				<script>
					var locations = [
						[46.4226507, 6.2615992, 'Agence Gland']
					];
				</script>
			<?php else : ?>
				<script>
					var locations = [
						[46.192858, 6.162241, 'Agence Florissant'],
						[46.193973, 6.195679, 'Agence Chêne'],
						[46.2042583, 6.1570301, 'Agence Eaux Vives']
					];
				</script>
			<?php endif; ?>
		...
		<div class="program <?php if (is_zenith()) {
								echo 'zenith_program';
							} ?>">
			<div class="container">
