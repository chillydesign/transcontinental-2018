...
<!-- <div id="featured_slide"><?php  //get_template_part('slides'); 
								?></div> -->
<div class="page_image" style="background-image:url('<?php echo get_the_post_thumbnail_url(); ?>')">
	<div class="container">
		...
		<a class="top_button" id="offre_slide" href="#reserver" class="button">
			<h6>Réservez maintenant</h6>
		</a>
	</div>
</div>
							...
							<div class="row ">
								...
								<div class="col-sm-4">
									<div class="more_info_box">
										...
										<?php if ($download) : ?>
											<a href="<?php echo $download; ?>" target="_blank" class="doc_link">
												<h6>Télécharger la documentation</h6>
											</a>
										<?php endif; ?>
										...
										<script>
											var send_offer_url = '<?php echo $tdu; ?>/send_offer.php';
										</script>
